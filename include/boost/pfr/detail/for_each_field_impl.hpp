...
void for_each_field_impl_apply(T&& v, F&& f, I i, long) {
    detail::forward<F>(f)(detail::forward<T>(v), i);
}

template <class T, class F, class I>
void for_each_field_impl_apply(T&& v, F&& f, I /*i*/, int) {
    detail::forward<F>(f)(detail::forward<T>(v));
}

template <class T, class F, std::size_t... I>
void for_each_field_impl(T& t, F&& f, detail::index_sequence<I...>, std::false_type /*move_values*/) {
     const int v[] = {(
         detail::for_each_field_impl_apply(sequence_tuple::get<I>(t), detail::forward<F>(f), size_t_<I>{}, 1L),
         0
     )...};
     (void)v;
}
...
void for_each_field_impl(T& t, F&& f, detail::index_sequence<I...>, std::true_type /*move_values*/) {
     const int v[] = {(
         detail::for_each_field_impl_apply(sequence_tuple::get<I>(detail::move(t)), detail::forward<F>(f), size_t_<I>{}, 1L),
         0
     )...};
     (void)v;
}
